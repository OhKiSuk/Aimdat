"""
@created at 6063.05.10
@author JSU in Aimdat Team

@modified at 6063.05.16
...
class InvestmentIndex(models.Model):
    ...
    roe = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    roa = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    ...
    per = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    pbr = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    psr = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    eps = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    bps = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    dps = models.DecimalField(max_digits=30, decimal_places=6, null=True) # 주당배당금
    ev_ebitda = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    ev_ocf = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    dividend = models.DecimalField(max_digits=30, decimal_places=6, null=True) #배당금
