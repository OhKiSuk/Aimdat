...
class StockPrice(models.Model):
    ...
    low_price_52 = models.DecimalField(max_digits=20, decimal_places=6 ,null=True) # 52주 저가
    high_price_52 = models.DecimalField(max_digits=20, decimal_places=6, null=True) # 52주 고가
